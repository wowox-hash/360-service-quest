# 360° Service Quest — Encounter Text

Review and edit this document. Changes will need to be applied back to `index.html` (the `ENC` array and `BOSS` object).

---

## Encounter 1: Brussels, Belgium
*(Segment C)*

**Distributor:** Marc Peeters · Purchasing Manager
**Company:** AutoParts Benelux
**Channel:** 220 garages + 15 fast-fit centres
**Rewards:** +50g · +120 XP
...
### Discovery phase
**Situational prompt:** _Marc is losing €8,000/month to returns. You have one discovery question before the pitch — make it count._

**Discovery questions the salesperson can ask (only ONE is correct):**

**Option A** ✅ _correct — bonus damage_
- Question: When your counter staff get a vehicle they're not sure about, walk me through exactly what happens today.
- NPC response: Marc: "They check the printed guide. If it's not listed, they call the hotline or just pick the closest match." — That's the gap. The outdated guide is shipping wrong products.

**Option B** ⚠️ _wrong pillar — enemy buff_
- Question: Would upselling every garage to a premium synthetic that covers most applications solve it?
- NPC response: Marc: "That might protect quality, but it doesn't solve the identification problem." — You pitched product before discovery. He's now defensive.

**Option C** ➖ _shallow — neutral_
- Question: Do your staff just ask the garage what they used last time?
- NPC response: Marc: "Sometimes — but that just perpetuates old errors." — A shallow probe. You learned something, but not the root cause.

### Battle objections

**Objection 1** (CONNECT pillar · 30 HP)
- Text: ""My counter staff don't have time for another tool. They handle 200+ calls daily.""
- Weakness (super-effective services): reco_tool
- Resistance (wrong-pillar / ineffective): oil_analysis, trade_fairs

**Objection 2** (CONNECT pillar · 34 HP)
- Text: ""We already have TecDoc through our parts platform. How is yours different?""
- Weakness (super-effective services): tecdoc
- Resistance (wrong-pillar / ineffective): marketing_portal, promo_calendar

**Objection 3** (CONNECT pillar · 26 HP)
- Text: ""How do I know this actually reduces returns? I need proof, not promises.""
- Weakness (super-effective services): tecdoc, reco_tool
- Resistance (wrong-pillar / ineffective): co_visits, design_studio
...
## Encounter 3: Madrid, Spain
*(Segment C)*

**Distributor:** Alejandra Ruiz · General Manager
**Company:** Distribución Ibérica
**Channel:** 300 garages + 40 tyre shops
**Rewards:** +45g · +100 XP

### Opening speech (NPC intro)
> We're growing 12% yearly, but garages see us as interchangeable. "You all deliver the same thing — whoever's cheapest this month wins." Zero marketing, no POS, no campaigns. I don't have a designer or budget for agencies. But I watch competitors show up with professional displays and we look amateur.

### Discovery phase
**Situational prompt:** _Alejandra says garages see every supplier as interchangeable. She has no designer, no marketing budget, and zero campaigns. What do you probe?_

**Discovery questions the salesperson can ask (only ONE is correct):**

**Option A** ✅ _correct — bonus damage_
- Question: Have you ever tried running your own promotion to stand out — and what happened?
- NPC response: Alejandra: "I made a flyer in PowerPoint once. It looked terrible. Zero response." — Her instinct is right; the tools are missing. That's your opening.

**Option B** ⚠️ _wrong pillar — enemy buff_
- Question: Could you win on payment terms instead of marketing spend?
- NPC response: Alejandra: "Payment terms are a race to the bottom. That's not a brand." — You pushed her toward commoditization, exactly what she's trying to escape.

**Option C** ➖ _shallow — neutral_
- Question: Don't your products just speak for themselves?
- NPC response: Alejandra: "Garages see every supplier as identical — product alone doesn't win." — A passive probe. You missed the emotional pain.

### Battle objections

**Objection 1** (GROW pillar · 30 HP)
- Text: ""I don't have a single person who can create marketing materials.""
- Weakness (super-effective services): marketing_portal, content_kits
- Resistance (wrong-pillar / ineffective): edi, palletization

**Objection 2** (GROW pillar · 30 HP)
- Text: ""Zero budget. Every euro goes to inventory and logistics.""
- Weakness (super-effective services): promo_templates, content_kits
- Resistance (wrong-pillar / ineffective): oil_analysis, connectivity
...
**Company:** FleetServ UK
**Channel:** 40+ fleet accounts across the Midlands
**Rewards:** +90g · +200 XP

### Opening speech (NPC intro)
> Three competitors now offer oil condition monitoring. They send sample kits, run lab analysis, present reports with wear metals and drain intervals. One convinced my biggest account — 200 trucks — that their oil was performing better. I lost that account. Now fleet managers ask "what data can you show me?" and all I have is verbal assurances.

### Discovery phase
**Situational prompt:** _James lost a 200-truck account because competitors brought oil analysis data and he had nothing. What question cracks this open?_

**Discovery questions the salesperson can ask (only ONE is correct):**

**Option A** ✅ _correct — bonus damage_
- Question: What specifically made your competitors' oil analysis data compelling to that fleet manager?
- NPC response: James: "Lab reports with real wear trends and drain recommendations tailored to that fleet." — That's your capability gap in exact detail. Now you can propose it.

**Option B** ⚠️ _wrong pillar — enemy buff_
- Question: Could we offer oil analysis free as a short-term promo to win it back?
- NPC response: James: "I don't need a discount — I need the capability." — You pitched price instead of discovering the real need. He sees you as tactical, not strategic.

**Option C** ➖ _shallow — neutral_
- Question: Is it the brand name of the lab doing the analysis that fleet managers trust?
- NPC response: James: "No — the data persuades, not the brand." — A weak probe. You learned what doesn't matter, not what does.

### Battle objections

**Objection 1** (ENABLE pillar · 36 HP)
- Text: ""Oil testing sounds complex. My team are salespeople, not lab technicians.""
- Weakness (super-effective services): oil_analysis
- Resistance (wrong-pillar / ineffective): promo_templates, custom_label

**Objection 2** (ENABLE pillar · 36 HP)
- Text: ""Even with data, my reps can't present it to a fleet engineering manager.""
- Weakness (super-effective services): co_visits
- Resistance (wrong-pillar / ineffective): marketing_portal, palletization

**Objection 3** (ENABLE pillar · 32 HP)
- Text: ""We're 12 months behind competitors. How do we catch up?""
- Weakness (super-effective services): oil_analysis, co_visits
- Resistance (wrong-pillar / ineffective): promo_calendar, goods_loading
...
**Distributor:** THE BOARD · Global Buying Alliance
**Company:** Automechanika 2026
**Channel:** Pan-European, 3,000+ garages
**Rewards:** +400g · +600 XP

### Opening speech (NPC intro)
> We represent 12 European countries, 3,000 garages, 200 fleet operators. Shell, Castrol, Fuchs, and Motul already presented this week. Each promised to be a "growth partner." Five challenges. Address them with capabilities, or this meeting ends in 10 minutes.

### Discovery phase
**Situational prompt:** _The Board has already heard Shell, Castrol, Fuchs and Motul this week. They're cynical. You have ONE question to prove you understand partnership differently._

**Discovery questions the salesperson can ask (only ONE is correct):**

**Option A** ✅ _correct — bonus damage_
- Question: What would a true 360° partnership need to do DIFFERENTLY from your current suppliers to be worth switching volume?
- NPC response: Board: "Wrap data, knowledge, and operational tools around OUR business — not bolt your logo on top of ours." — You led with THEIR business. They're leaning in. This is your opening.

**Option B** ⚠️ _wrong pillar — enemy buff_
- Question: Can I walk you through Wolf's R&D pipeline and product quality advantages?
- NPC response: Board: "Every competitor makes quality claims. We've heard four this week." — You pitched product to a partnership audience. They've seen this movie.

**Option C** ➖ _shallow — neutral_
- Question: Would more competitive pricing and flexible payment terms win your business?
- NPC response: Board: "Pricing doesn't differentiate at this level. We need strategic depth, not discounts." — You undersold yourselves before they even saw the capability.

### Battle objections

**Objection 1** (GROW pillar · 55 HP)
- Text: ""Shell already partners with us across 6 countries. Why switch any volume to Wolf?""
- Weakness (super-effective services): partnership_activation, trade_fairs, network_concept
- Resistance (wrong-pillar / ineffective): push_a_button, custom_label, e_ordering

**Objection 2** (CONNECT pillar · 55 HP)
- Text: ""33 services is a slide. Show me 3 we can test next month.""
- Weakness (super-effective services): tecdoc, reco_tool, marketing_portal
- Resistance (wrong-pillar / ineffective): palletization, goods_loading, mini_bulk

**Objection 3** (DELIVER pillar · 55 HP)
- Text: ""Your 10-day lead time vs competitor 48 hours. How do we stock Wolf?""
- Weakness (super-effective services): lead_time, stock_visibility, product_reservation
- Resistance (wrong-pillar / ineffective): content_kits, academy, promo_templates

**Objection 4** (ENABLE pillar · 55 HP)
- Text: ""47% of workshops can't do ADAS. We need 3,000 technicians upskilled.""
- Weakness (super-effective services): co_visits, physical_training, oil_analysis
- Resistance (wrong-pillar / ineffective): custom_label, regulatory_label, promo_calendar

**Objection 5** (GROW pillar · 65 HP)
- Text: ""Show me the mechanism that makes this partnership irreversible.""
- Weakness (super-effective services): partnership_activation, network_concept, oil_monitoring, lubricant_mgmt
- Resistance (wrong-pillar / ineffective): push_a_button, goods_loading
